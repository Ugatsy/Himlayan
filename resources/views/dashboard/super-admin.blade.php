...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-4 p-5">
        ...
        <div class="mt-3 flex gap-3 text-xs">
            <span class="text-green-600 font-medium">{{ $availablePlots }} available</span>
            <span class="text-gray-300">|</span>
            <span class="text-amber-600 font-medium">{{ $reservedPlots }} reserved</span>
            <span class="text-gray-300">|</span>
            <span class="text-red-600 font-medium">{{ $occupiedPlots }} occupied</span>
        </div>
    </div>
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-4 p-5">
        <div class="flex items-start justify-between">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-4 p-5">
        ...
        <div class="mt-3 text-xs text-gray-500">All time</div>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-4 p-5">
        <div class="flex items-start justify-between">
            <div>
                <div class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Pre-Need Plans</div>
                <div class="mt-1 text-3xl font-bold text-brand-blue">{{ $activePlans }}</div>
            </div>
            <div class="w-10 h-10 rounded-full bg-brand-blue/10 flex items-center justify-center shrink-0">
        ...
        <div class="mt-3">
            <a href="{{ route('pre-need-plans.index') }}" class="text-xs text-brand-blue hover:text-brand-blue-dark font-medium">Manage plans &rarr;</a>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-4 p-5">
        ...
        <div class="mt-2">
            <a href="{{ route('columbary-niches.index') }}" class="text-sm text-brand-blue hover:text-brand-blue-dark font-medium">Manage</a>
        </div>
    </div>
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-4 p-5">
        ...
        <div class="mt-2">
            <a href="{{ route('contracts.index') }}" class="text-sm text-brand-blue hover:text-brand-blue-dark font-medium">View</a>
        </div>
    </div>
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-4 p-5">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-4 p-5">
        ...
        <div class="mt-2">
            <a href="{{ route('activity-logs.index') }}" class="text-sm text-brand-blue hover:text-brand-blue-dark font-medium">View all</a>
        </div>
    </div>
</div>

<!-- Row 4: Recent Burials + Payments -->
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-4 p-5 lg:col-span-2">
                    ...
                    <div class="flex items-start gap-2">
                        <span class="shrink-0 mt-0.5">
                            ...
                            @elseif($log->type === 'contract')
                                <svg class="w-4 h-4 text-brand-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="text-xs text-gray-400">{{ $log->user?->name ?? 'System' }} &middot; {{ $log->created_at?->diffForHumans() }}</div>
                        </div>
                    </div>
                </div>
            @empty
