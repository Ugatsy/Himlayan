<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        ...
        <div class="mt-1 text-sm">
            <a href="{{ route('payments.index') }}" class="text-indigo-600 hover:text-indigo-900">View payments</a>
        </div>
    </div>
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        ...
        <div class="mt-1 text-sm">
            <a href="{{ route('inquiries.index') }}" class="text-indigo-600 hover:text-indigo-900">View</a>
        </div>
    </div>
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        ...
        <div class="mt-1 text-sm">
            <a href="{{ route('burial-permits.create') }}" class="text-indigo-600 hover:text-indigo-900">Issue New</a>
        </div>
    </div>
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
