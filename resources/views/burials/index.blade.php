                                ...
                                <tr class="border-b hover:bg-gray-50 burial-row">
                                    ...
                                    <td>
                                        <span class="inline-flex items-center gap-1 text-xs px-2.5 py-1 rounded-full font-medium
                                            ...
                                            @if($burial->burial_status === 'completed') <span class="w-1.5 h-1.5 rounded-full bg-green-500"></span>
                                            @elseif($burial->burial_status === 'scheduled') <span class="w-1.5 h-1.5 rounded-full bg-blue-500"></span> @endif
                            ...
                            @empty
                                <tr id="empty-row"><td colspan="6">
                                    <div class="py-12 text-center">
                                        ...
                                        <p class="text-gray-400 text-sm mt-1">Schedule a burial when a plot is ready for interment.</p>
