            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('burial-permits.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="deceased_name" value="{{ old('deceased_name') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    <div class="mb-4 grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="date_of_death" value="{{ old('date_of_death') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" name="burial_permit_fee" value="{{ old('burial_permit_fee', '0') }}" min="0" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="flex items-center justify-end gap-4">
                        ...
                        <button type="submit" class="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700">Issue Permit</button>
                    </div>
                </form>
            </div>
        </div>
